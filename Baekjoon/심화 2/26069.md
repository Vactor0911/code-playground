...
**문제 바로가기** : [26069 붙임성 좋은 총총이](https://www.acmicpc.net/problem/26069 "26069 붙임성 좋은 총총이")
...
dictionary = {"ChongChong": 1}

for _ in range(loops):
    a, b = stdin.readline().split()
    dance = max( (dictionary[a] if a in dictionary else 0), (dictionary[b] if b in dictionary else 0) )
    dictionary[a] = dance
    dictionary[b] = dance
